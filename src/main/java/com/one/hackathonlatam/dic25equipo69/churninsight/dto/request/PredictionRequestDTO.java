...
public record PredictionRequestDTO(
        ...
        @Schema(description = "País del cliente", example = "Spain")
        Geography geography,
        ...
        @Schema(description = "Edad del cliente", example = "42")
        Integer age,
        ...
        @Schema(description = "Puntuación de crédito del cliente", example = "650")
        Integer creditScore,

        @NotNull(message = "El campo 'balance' es obligatorio")
        @DecimalMin(value = "0.0", message = "El balance no puede ser negativo")
        @Schema(description = "Balance de la cuenta del cliente", example = "14.5")
        Double balance,

        @DecimalMin(value = "0.0", message = "El salario estimado no puede ser negativo")
        ...
        @Schema(description = "Número de productos que tiene el cliente", example = "5")
        ...
        @Schema(description = "Nivel de satisfacción del cliente (1-5)", example = "2")
        Integer satisfactionScore,

        @NotNull(message = "El campo 'isActiveMember' es obligatorio")
        @Schema(description = "Indica si el cliente es miembro activo", example = "true")
        ...
        @Schema(description = "Indica si el cliente ha presentado quejas", example = "false")
        Boolean complain
) {}
